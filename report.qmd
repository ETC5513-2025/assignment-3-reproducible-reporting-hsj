...
The amount of internship and projects you complete before, your SAT score and Gender are some very strong predictors. High school and university GPA are slightly important variable while certification, networking score, what field did you study and age are just neutral since they did not help or hurt the prediction in anyway.

On the other hand, university ranking, sort skills score, current job level, starting salary, year to promotion and entrepreneurship variables are very bad predictors that are just not relevant to the job offers you may get.
